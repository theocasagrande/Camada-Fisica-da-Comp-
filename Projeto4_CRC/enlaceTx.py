    ...
    def thread(self):
        while not self.threadStop:
            if(self.threadMutex):
                ...
                # Sem essa pausa a thread gira em laco vazio e consome 100% de um
                # nucleo o tempo todo, roubando CPU da thread de RX (que e quem
                # precisa acompanhar a linha serial sem perder bytes).
                time.sleep(0.001)
